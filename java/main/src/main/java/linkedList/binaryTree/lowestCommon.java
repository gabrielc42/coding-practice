...
public class lowestCommon {
    public static void main(String[] args) throws NullPointerException {
        ...
        System.out.println(lca(head1, 1, 5).toString()); // should return 0
        System.out.println(lca(head1, 3, 1).toString()); // should return 1
        System.out.println(lca(head1, 1, 4).toString()); // should return 1
        System.out.println(lca(head1, 0, 5).toString()); // should return 0
        System.out.println(lca(head2, 4, 7).toString()); // should return 5
        System.out.println(lca(head2, 3, 3).toString()); // should return 3
        System.out.println(lca(head2, 8, 7).toString()); // should return 1
        System.out.println(lca(head2, 3, 0).toString()); // should return null (0 does not exist in the tree)
    }
